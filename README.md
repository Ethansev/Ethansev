...
I'm Ethan, a full stack engineer :) This is where I test random ideas and contribute to projects I genuinely enjoy. 
...
- **Yelp Clone** (Refactoring with React and the NPS API for back end)
- **Development Blog** (Astro)
